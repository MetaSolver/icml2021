...
# Main idea
Each *Runge-Kutta (RK)* solver with `s` stages and of the `p`-th order is defined by a table of coefficients (*Butcher tableau*). For `s=p=2`, `s=p=3` and `s=p=4` all coefficient in the table can be parametrized with no more than two variables [1]. We show below the Butcher tableau of such parameterization for RK2 method and two Butcher tableux of particular methods from this parametric family.

<p float="center">
  <img src="/pics/rk2_param.png" width="300" />
  <img src="/pics/midpoint.png" width="150" /> 
  <img src="/pics/heun.png" width="150" />
</p>
